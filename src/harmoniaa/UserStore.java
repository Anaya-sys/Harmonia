...
public class UserStore {
     ...
     * Formato de cada línea: id|nombre|email|contraseña|tipoPerfil|instrumento|presupuesto|rol
     */
    private static void cargarDesdeArchivo() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(ARCHIVO))) {
            ...
            while ((linea = reader.readLine()) != null) {
                ...
                if (partes.length < 8) continue;   // línea incompleta, la saltamos
                ...
                double presupuesto = Double.parseDouble(partes[6]);
                Rol    rol         = Rol.valueOf(partes[7]);

                PerfilUsuario perfil = new PerfilUsuario(tipo, instrumento, presupuesto);
