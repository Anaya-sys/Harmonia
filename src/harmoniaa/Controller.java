...
public class Controller {
    ...
    private void manejarLogin() {
        ...
        mostrarFeedback("✓  Sesión iniciada correctamente.", FEEDBACK_OK);
    }
    ...
    private void manejarRegistro() {
        ...
        if (nombre.isEmpty() || id.isEmpty() || correo.isEmpty() || password.isEmpty()) {
            mostrarFeedback("⚠  Completa todos los campos.", FEEDBACK_ERROR);
            return;
        }
        if (!correo.contains("@")) {
        ...
        mostrarFeedback("✓  Cuenta creada exitosamente.", FEEDBACK_OK);
    }
